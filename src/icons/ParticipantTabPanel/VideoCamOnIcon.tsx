...
interface VideoCamOnIconProps extends React.SVGProps<SVGSVGElement> {
  // You can add custom props if needed here
}

const VideoCamOnIcon: React.FC<VideoCamOnIconProps> = (props) => (
  <svg
    width={18}
    height={18}
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    {...props} // Spread props to allow for flexibility (fill, className, etc.)
  >
    <mask
      id="a"
      style={{
