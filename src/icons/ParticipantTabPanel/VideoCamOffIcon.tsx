...
interface VideoCamOffIconProps extends React.SVGProps<SVGSVGElement> {
  // You can add custom props here if needed, for example, a custom `fill` color
}

const VideoCamOffIcon: React.FC<VideoCamOffIconProps> = (props) => (
  <svg
    width={18}
    height={18}
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    {...props} // Spread the props to allow flexibility (className, style, fill, etc.)
  >
    <path
