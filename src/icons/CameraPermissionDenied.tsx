...
// Define the type for props to accept all standard SVG properties
interface CameraPermissionDeniedProps extends React.SVGProps<SVGSVGElement> {
  // You can add custom props if needed here
}
...
const CameraPermissionDenied: React.FC<CameraPermissionDeniedProps> = (
  ...
  <svg
    ...
    fill="none"
    viewBox="0 0 56 56"
    {...props} // Spread props to allow for flexibility (e.g., className, fill, etc.)
  >
    ...
    <defs>
      ...
      <clipPath id="clip0_20_1271">
        <path fill="#fff" d="M0 0H20V20H0z" transform="translate(18 18)"></path>
      </clipPath>
    </defs>
  </svg>
);
