...
interface WebcamOffIconProps extends React.SVGProps<SVGSVGElement> {
  fillcolor?: string; // Optional 'fillcolor' prop to allow customization of the icon color
}

const WebcamOffIcon: React.FC<WebcamOffIconProps> = (props) => (
  <svg
    width={24}
    height={24}
    fill="none"
  ...
  >
    <g clipPath="url(#a)">
      <path
        ...
        fill={props.fillcolor || '#050A0E'} // Default fill color is #050A0E if no 'fillcolor' is provided
      />
    </g>
    <defs>
      <clipPath id="a">
        <path
          fill={props.fillcolor || '#050A0E'} // Ensure fillcolor is applied in the clipPath as well
