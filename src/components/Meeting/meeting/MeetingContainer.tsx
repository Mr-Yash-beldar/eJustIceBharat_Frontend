...
import { Constants, useMeeting, useParticipant, usePubSub, Participant } from "@videosdk.live/react-sdk";
...
export function MeetingContainer({
  ...
  return (
    <div className="fixed inset-0">
                ...
                <div className={`flex flex-1 `}>
                  {isPresenting ? (
                    ...
                    <MemorizedParticipantView
                      ...
                      localParticipant={mMeeting?.localParticipant}
                      isTablet={isTab}
                    />
                  )}
                </div>
      ...
      <ConfirmBox
        visible={meetingErrorVisible}
        code={meetingError?.code || 0}
        message={meetingError?.message || "Error joining meeting!"}
        onConfirm={() => setMeetingErrorVisible(false)}
      />
    </div>
  );
}
