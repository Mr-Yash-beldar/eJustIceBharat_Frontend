...
export function PresenterView({ height }: PresenterViewProps): JSX.Element {
  ...
  const mediaStream = useMemo<MediaStream | undefined>(() => {
          ...
          <>
            ...
            <CornerDisplayName
              {...{
                ...
                isActiveSpeaker: isActiveSpeaker || false,
              }}
            />
          </>
        ) : (
