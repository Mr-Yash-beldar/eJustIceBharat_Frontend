...
// Define the props type for the SideBarTabView component
...
// Define the props type for the SidebarConatiner component
interface SidebarConatinerProps {
  height: string | number;
  sideBarContainerWidth: string | number;
}
