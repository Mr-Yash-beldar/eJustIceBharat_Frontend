...
// Define types for the props of the ParticipantListItem component
interface ParticipantListItemProps {
  participantId: string;
  raisedHand: boolean;
}

function ParticipantListItem({ participantId, raisedHand }: ParticipantListItemProps) {
...
// Define types for the props of the ParticipantPanel component
...
export function ParticipantPanel({ panelHeight }: ParticipantPanelProps) {
  ...
  const filterParticipants = (sortedRaisedHandsParticipants: { raisedHand: boolean; participantId: string }[]) =>
