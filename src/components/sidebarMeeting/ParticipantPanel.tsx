...
// Typing for the ParticipantListItem props
...
// Typing for the ParticipantPanel props
...
export function ParticipantPanel({ panelHeight }: ParticipantPanelProps) {
  ...
  // Now filterParticipants only accepts sortedRaisedHandsParticipants
    ...
    >
      ...
      >
        {[...participants.keys()].map((participantId, index) => {
          ...
          return (
            <ParticipantListItem
              key={participantId} // Added key prop for list rendering
