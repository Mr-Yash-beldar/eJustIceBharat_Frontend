...
// Define the interface for SideBarTabViewProps
interface SideBarTabViewProps {
  height: string;
  sideBarContainerWidth: string;
  panelHeight: number;
  raisedHandsParticipants: { participantId: string; raisedHandOn: number }[]; // Add raisedHandsParticipants here
...
export function SidebarContainer({
  ...
  return sideBarMode ? (
    isTab || isMobile ? (
              ...
              <div className="flex h-screen items-center justify-center text-center">
                <Dialog.Panel className="w-screen transform overflow-hidden bg-gray-800 shadow-xl transition-all">
                  <SideBarTabView
                    ...
                    panelHeight={height}
                    raisedHandsParticipants={raisedHandsParticipants} // Ensure it's passed here
      ...
      <SideBarTabView
        height={paddedHeight.toString()} // Convert number to string here
