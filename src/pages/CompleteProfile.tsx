...
const CompleteProfile: React.FC = () => {
  ...
  //handel other doc upload
  const handelOtherDocUpload = () => {
    console.log('Other Doc Upload');
  };
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-center space-y-2">
                    ...
                    {LitigantDetails.aadhar_document ? (
                      <>
                        <span className="text-center text-sm text-primary">
                          You Have Uploaded Your Aadhar Proof You can Update it
                          Here
                        </span>
                        <span className="text-center text-sm text-primary">
                          ?
