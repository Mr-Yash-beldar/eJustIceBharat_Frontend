            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-5">
                  ...
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="flex gap-2.5">
                        <button className="text-sm hover:text-primary" onClick={handelProfileUpload}>
                          Save Profile
                        </button>
                      </span>
                    </div>
                      ...
                      {LitigantDetails.profile_image ? (
                        <>
                          <span className="text-center text-sm text-primary">
                            You Have Uploaded Your Profile You can Update it
                            Here
                          </span>
                          <span className="text-center text-sm text-primary">
                            ?
                  ...
                  <div className="mb-5.5 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="flex gap-2.5 mt-1">
                        <button className="text-sm hover:text-primary" onClick={handelAadharUpload}>
                          Save Aadhaar Proof
                        </button>
                      </span>
                    </div>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2">
                      <span className="flex h-10 w-10 items-center justify-center rounded-full border border-stroke bg-white dark:border-strokedark dark:bg-boxdark">
                        {LitigantDetails.aadhar_document ? (
                          <img
                            src="https://cdn-icons-png.flaticon.com/512/14090/14090371.png"
                            alt="User"
                          />
                      ...
                      {LitigantDetails.aadhar_document ? (
                        <>
                          <span className="text-center text-sm text-primary">
                            You Have Uploaded Your Aadhar Proof You can Update
                            it Here
                          </span>
                          <span className="text-center text-sm text-primary">
                            ?
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center justify-center space-y-2">
                      <span className="flex h-10 w-10 items-center justify-center rounded-full border border-stroke bg-white dark:border-strokedark dark:bg-boxdark">
                        {LitigantDetails.other_document ? (
                          <img
                            src="https://cdn-icons-png.flaticon.com/512/14090/14090371.png"
                            alt="User"
                          />
