...
const AdvocateList = () => {
  ...
  const handleCloseModal = () => setSelectedAdvocate(null);
  ...
  return (
    <div className="p-6">
          ...
          <div className="absolute right-0 mt-64 w-64 bg-white shadow-lg rounded-lg z-10 border border-gray-200 p-4 transform translate-y-12">
            ...
            <label className="mt-4 flex items-center">
              <input
                ...
                onChange={() => handleFilterChange('nearMe', !filterCriteria.nearMe)}
              />
              Near Me
            </label>
          </div>
      ...
      {/* Advocate Grid */}
      <div className="mt-4">
        <AdvocateGrid advocates={displayedAdvocates} onViewMore={handleViewMore} />
      </div>
      ...
      {selectedAdvocate && (
        <AdvocateDetailsModal advocate={selectedAdvocate} onClose={handleCloseModal} />
      )}
    </div>
  );
};
