...
const CaseCardOfficer: React.FC<CaseCardProps> = ({ caseData, onViewMore }) => {
  const { case_title, case_type, filing_date, advocate_name } = caseData;
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-300 ease-in-out">
      ...
      <p className="text-gray-600 text-sm">Advocate: {advocate_name}</p>
...
export default CaseCardOfficer;
